// When this file loaded, sends a message to the content file (using chrome.tabs.query
// instead of .sendMessage to message a content file.) This file expects the processed
// data in response
...
chrome.tabs.query({active: true, currentWindow: true}, function(tabs) {
		chrome.tabs.sendMessage(tabs[0].id, {type: "getReports"}, function(data) {
			...
			// Sets the text for the browser_action HTML by id tag: filling with processed data
